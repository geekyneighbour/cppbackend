...
BOOST_LOG_ATTRIBUTE_KEYWORD(additional_data, "additional_data", boost::json::value)
...
int main(int argc, const char* argv[]) {
    ...
    try {
        ...
        json::value exit_data = std::move(exit_data_obj);

        BOOST_LOG_TRIVIAL(info)
            << boost::log::add_value(additional_data, exit_data)
            << "server exited";
